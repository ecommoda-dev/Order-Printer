...
**مين بيستخدمها:** مخزن
**الإصدار:** Worker `v2.0.0` · الواجهة `v3.1.0` (`TOOL_VERSION`) · `MIN_WORKER_VERSION = 2.0.0`
=======
![version](https://img.shields.io/badge/version-v3.0.0-blue)

**بتعمل إيه:** الموظف بيسجّل دخول بـ PIN، بيختار أوردرات جاهزة للطباعة (S1 عادي · S2 استبدال/استرجاع)، بيطبع فواتيرها، والأداة بتسجّل الطباعة باسمه وبتحدّث حالة الأوردر لـ `Ready`.
**مين بيستخدمها:** مخزن
**الإصدار:** Worker `v2.0.0` · الواجهة `v3.0.0` (`TOOL_VERSION`) · `MIN_WORKER_VERSION = 2.0.0`
>>>>>>> origin/main
...
<<<<<<< HEAD
آخر مطابقة: 03-09-2026 · `index.js` v2.0.0 · `index.html` v3.1.0
=======
آخر مطابقة: 03-09-2026 · `index.js` v2.0.0 · `index.html` v3.0.0
>>>>>>> origin/main
